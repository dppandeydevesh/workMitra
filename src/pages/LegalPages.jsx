        ...
        <div className="flex justify-between items-center border-b pb-6 mb-8 gap-4">
          <div>
            <img 
              ...
              onClick={() => navigate("/")} 
            />
            <h1 className="text-xl sm:text-2xl font-black text-gray-800 tracking-tight mt-3">
              {title}
            </h1>
  ...
  return (
    <LegalLayout title="Terms of Service" subtitle="Agreement and Platform Conditions">
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">1. Acceptance of Terms</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">2. Account Responsibility</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">3. Freelancing Gigs & AI Match</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">4. Payment & Escrow Protection</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">5. Prohibited Conduct</h3>
        <p>
...
export function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy" subtitle="Your Personal Data & Safety Information">
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">1. Data We Collect</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">2. How We Use Data</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">3. Payout & Security Details</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">4. Profile Visibility</h3>
        <p>
...
export function RefundPage() {
  return (
    <LegalLayout title="Refund & Cancellation" subtitle="Subscription & Transaction Protections">
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">1. Subscription Tiers</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">2. Project Cancellation</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">3. Solution Disapproval</h3>
        <p>
      ...
      <section className="space-y-2">
        <h3 className="text-sm font-black text-gray-800 uppercase tracking-wider">4. Contact Support</h3>
        <p>
