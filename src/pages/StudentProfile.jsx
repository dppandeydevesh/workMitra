          ...
          <div className="bg-white rounded-xl shadow-sm p-8 text-center space-y-4">
            ...
            <div className="flex justify-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl text-xs font-bold transition shadow-sm hover:opacity-90"
              >
                Retry
              </button>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border border-ink-200">
              <div className="flex items-center gap-4">
                {profileUser.avatarUrl ? (
                  ...
                  <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-paper to-marigold-600 text-white flex items-center justify-center text-3xl font-black shadow-md">
                  ...
                  <div className="flex items-center flex-wrap gap-2">
                    ...
                    {profileUser.githubUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-ink-600 hover:text-black transition ml-1"
                        title="GitHub"
                      >
                        <svg
                          className="w-5 h-5"
                    ...
                    {profileUser.linkedinUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-marigold-500 hover:text-marigold-800 transition"
                        title="LinkedIn"
                      >
                        <svg
                          className="w-5 h-5"
              ...
              {!isOwner && currentUser?.userRole === 'company' && (
                <button
                  ...
                  className="px-4 py-2.5 bg-gradient-to-r from-paper to-pink-600 hover:opacity-95 text-white rounded-xl text-xs font-bold transition shadow-md flex items-center gap-1.5"
                >
            ...
            {isEditing ? (
              <form
                ...
                className="bg-white rounded-xl shadow-sm p-6 md:p-8 space-y-6 border border-ink-200"
              >
                <h3 className="text-lg font-bold text-ink-800 border-b pb-3">
                  {t('studentProfile.editPortfolioDetails')}
                </h3>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Full name */}
                  <div>
                    <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1.5">
                      {t('studentProfile.fullName')}
                    </label>
                    <input
                      type="text"
                      value={fullName}
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1.5">
                      {t('studentProfile.enrollmentNumber')}
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1.5">
                      {t('studentProfile.workTypePreference')}
                    </label>
                    <select
                      value={projectType}
                      ...
                      className="w-full bg-ink-50 border border-ink-200 text-xs px-3.5 py-2.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-marigold-400"
                    >
                      <option value="Remote Track">
                        {t('studentProfile.remoteTrack')}
                      </option>
                      <option value="On-site Internship">
                        {t('studentProfile.onSiteInternship')}
                      </option>
                      <option value="Part-time Gig">
                        {t('studentProfile.partTimeGig')}
                      </option>
                      <option value="Hybrid Track">
                        {t('studentProfile.hybridTrack')}
                      </option>
                    </select>
                  </div>
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1.5">
                      {t('studentProfile.portfolioLink')}
                    </label>
                    <input
                      type="url"
                      value={portfolioUrl}
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1.5">
                      {t('studentProfile.avatarUrlLabel')}
                    </label>
                    <input
                      type="url"
                      value={avatarUrl}
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1.5">
                      {t('studentProfile.academicMajor')}
                    </label>
                    <input
                      type="text"
                      value={major}
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1.5">
                      {t('studentProfile.currentSemesterLabel')}
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1.5">
                      {t('studentProfile.videoPitchLink')}
                    </label>
                    <input
                      type="url"
                      value={videoPitchUrl}
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1.5">
                      {t('studentProfile.preferredTechStackLabel')}
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="flex items-center gap-3 pt-6">
                    ...
                    />
                    <label
                      htmlFor="isProfilePrivate"
                      className="text-xs font-bold text-ink-700 cursor-pointer"
                    >
                ...
                <div>
                  <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1.5">
                    {t('studentProfile.extracurricularsLabel')}
                  </label>
                  <input
                    type="text"
                    ...
                    placeholder={t(
                      'studentProfile.extracurricularsPlaceholder'
                    )}
                    className="w-full bg-ink-50 border border-ink-200 text-xs px-3.5 py-2.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-marigold-400"
                  />
                </div>
                ...
                <div>
                  <label className="block text-[10px] font-bold text-ink-400 uppercase mb-2">
                    {t('studentProfile.availabilitySlotsLabel')}
                  </label>
                      ...
                      return (
                        <button
                          ...
                          onClick={() => {
                            if (isSelected) {
                              setAvailabilitySlots(
                                availabilitySlots.filter((s) => s !== slot)
                              );
                            } else {
                              setAvailabilitySlots([
                                ...availabilitySlots,
                          ...
                          className={`px-3.5 py-2 rounded-xl text-xs font-bold transition border ${
                            isSelected
                              ? 'bg-marigold-500 border-marigold-700 text-white'
                              : 'bg-ink-50 hover:bg-ink-100 text-ink-500 border-ink-200'
                          }`}
                        >
                          {slot}
                        </button>
                ...
                <div>
                  <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1.5">
                    {t('studentProfile.professionalBio')}
                  </label>
                  <textarea
                    value={bioText}
                ...
                <div className="flex justify-end gap-3 pt-2">
                  ...
                  <button
                    ...
                    disabled={saving}
                    style={{ background: '#F5A623', color: '#1B2333' }}
                    className="px-4 py-2 rounded-xl text-xs font-bold transition shadow-md hover:opacity-90"
                  >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                  <div className="bg-white rounded-xl shadow-sm p-6 border border-ink-200 space-y-5">
                    <h3 className="text-sm font-black text-ink-800 uppercase tracking-wider border-b pb-2.5">
                      {t('studentProfile.studentMetadata')}
                    </h3>

                    {/* Email */}
                    <div className="text-xs">
                      <span className="text-[10px] uppercase font-bold text-ink-400 block mb-0.5">
                        {t('studentProfile.primaryEmail')}
                      </span>
                    ...
                    <div className="text-xs">
                      <span className="text-[10px] uppercase font-bold text-ink-400 block mb-0.5">
                        {t('studentProfile.mobileContact')}
                      </span>
                      <span className="font-bold text-ink-700">
                        {profileUser.mobile || t('studentProfile.notProvided')}
                      </span>
                    </div>
                    ...
                    <div className="text-xs">
                      <span className="text-[10px] uppercase font-bold text-ink-400 block mb-0.5">
                        {t('studentProfile.universityNode')}
                      </span>
                      <span className="font-bold text-ink-700">
                        {profileUser.collegeName ||
                          t('studentProfile.notVerified')}
                      </span>
                      {profileUser.enrollmentNumber && (
                        <p className="text-[10px] text-marigold-500 font-semibold mt-0.5">
                          ID: {profileUser.enrollmentNumber}
                        </p>
                      )}
                    </div>
                    ...
                    <div className="text-xs">
                      <span className="text-[10px] uppercase font-bold text-ink-400 block mb-0.5">
                        {t('studentProfile.trackPreference')}
                      </span>
                      <span className="font-bold text-ink-700">
                        {profileUser.projectType ||
                          t('studentProfile.remoteTrack')}
                      </span>
                    </div>
                    ...
                    <div className="text-xs border-t pt-3">
                      ...
                      {profileUser.resumeUrl ? (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="text-marigold-500 hover:text-marigold-800 font-bold hover:underline flex items-center gap-1"
                        >
                          📄 {t('studentProfile.openResume')} ↗
                        </a>
                      ) : (
                        <span className="text-ink-400 italic">
                          {t('studentProfile.noResumeUploaded')}
                        </span>
                      )}
                    </div>
                    ...
                    <div className="text-xs border-t pt-3 space-y-2">
                      <span className="text-[10px] uppercase font-bold text-ink-400 block mb-1">
                        {t('studentProfile.professionalChannels')}
                      </span>
                      <div className="flex flex-col gap-1.5">
                        {profileUser.githubUrl ? (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="text-ink-700 hover:text-ink-dark font-semibold flex items-center gap-1.5"
                          >
                            <span>💻 {t('studentProfile.github')}</span>{' '}
                            <span className="hover:underline text-[11px] truncate max-w-[130px]">
                              {profileUser.githubUrl.split('/').pop()}
                            </span>
                          </a>
                        ) : (
                          <span className="text-ink-400 italic text-[11px]">
                            {t('studentProfile.noGithubConnected')}
                          </span>
                        )}
                        {profileUser.linkedinUrl ? (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="text-marigold-500 hover:text-ink-dark font-semibold flex items-center gap-1.5"
                          >
                            <span>👔 {t('studentProfile.linkedin')}</span>{' '}
                            <span className="hover:underline text-[11px] truncate max-w-[130px]">
                              {profileUser.linkedinUrl.split('/').pop()}
                            </span>
                          </a>
                        ) : (
                          <span className="text-ink-400 italic text-[11px]">
                            {t('studentProfile.noLinkedinConnected')}
                          </span>
                        )}
                        {profileUser.portfolioUrl ? (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="text-green-600 hover:text-ink-dark font-semibold flex items-center gap-1.5"
                          >
                            <span>🌐 {t('studentProfile.website')}</span>{' '}
                            <span className="hover:underline text-[11px] truncate max-w-[130px]">
                              {profileUser.portfolioUrl.replace(
                                /^https?:\/\//,
                                ''
                              )}
                            </span>
                          ...
                          <span className="text-ink-400 italic text-[11px]">
                            {t('studentProfile.noWebsiteConnected')}
                          </span>
                        )}
                      </div>
                    </div>
                    ...
                    {(profileUser.major || profileUser.currentSemester) && (
                      <div className="text-xs border-t pt-3">
                        <span className="text-[10px] uppercase font-bold text-ink-400 block mb-0.5">
                          {t('studentProfile.academicTrack')}
                        </span>
                        {profileUser.major && (
                    ...
                    <div className="text-xs border-t pt-3 flex flex-col items-center text-center">
                      <span className="text-[10px] uppercase font-bold text-ink-400 block mb-2">
                        {t('studentProfile.readinessScore')}
                      </span>
                      <div
                        style={{
                      ...
                      <p className="text-[9px] text-ink-400 mt-2 font-medium">
                        {t('studentProfile.readinessDescription')}
                      </p>
                    </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 border border-ink-200 space-y-6">
                    <div>
                      <h3 className="text-sm font-black text-ink-800 uppercase tracking-wider border-b pb-2.5 mb-4">
                        {t('studentProfile.professionalBio')}
                      </h3>
                        ...
                        {profileUser.targetSkills ? (
                          profileUser.targetSkills
                            ...
                            .map((skill, idx) => (
                              <span
                                key={idx}
                                className="bg-marigold-50 text-marigold-700 text-xs font-bold px-3 py-1 rounded-xl border border-marigold-100"
                              >
                                {skill.trim()}
                              </span>
                            ))
                          ...
                          <span className="text-xs text-ink-400 italic">
                            {t('studentProfile.noSkillsListed')}
                          </span>
                        )}
                      </div>
                    </div>
                    ...
                    {/* Preferred Tech Stack */}
                    {profileUser.preferredTechStack &&
                      profileUser.preferredTechStack.length > 0 && (
                        <div className="border-t pt-4">
                          <h4 className="text-[11px] font-black uppercase text-ink-400 tracking-wider mb-2">
                            {t('studentProfile.preferredTechStackLabel')}
                          </h4>
                          <div className="flex flex-wrap gap-1.5">
                            {profileUser.preferredTechStack.map((tech, idx) => (
                              <span
                                key={idx}
                                className="bg-paper text-ink-dark text-xs font-bold px-3 py-1 rounded-xl border border-border"
                              >
                                #{tech}
                              </span>
                            ))}
                    ...
                    {/* Extracurriculars */}
                    {profileUser.extracurriculars &&
                      profileUser.extracurriculars.length > 0 && (
                        <div className="border-t pt-4">
                          <h4 className="text-[11px] font-black uppercase text-ink-400 tracking-wider mb-2">
                            {t('studentProfile.hackathonsExtraActivities')}
                          </h4>
                          <ul className="list-disc list-inside text-xs text-ink-600 space-y-1">
                            {profileUser.extracurriculars.map(
                              (activity, idx) => (
                    ...
                    {profileUser.availabilitySlots &&
                      profileUser.availabilitySlots.length > 0 && (
                        <div className="border-t pt-4">
                          <h4 className="text-[11px] font-black uppercase text-ink-400 tracking-wider mb-2">
                            {t('studentProfile.weeklyAvailability')}
                          </h4>
                          <div className="flex gap-1.5 flex-wrap">
                            {profileUser.availabilitySlots.map((slot, idx) => (
                              <span
                                key={idx}
                                className="bg-emerald-50 text-emerald-700 text-[10px] font-extrabold px-2.5 py-0.5 rounded-lg border border-emerald-100 uppercase"
                              >
                                {slot}
                              </span>
                            ))}
                  ...
                  {profileUser.videoPitchUrl && (
                    <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 border border-ink-200 space-y-4 print:hidden">
                      ...
                      <div className="aspect-video w-full rounded-xl overflow-hidden bg-ink-900 border">
                        <iframe
                          src={
                            profileUser.videoPitchUrl.includes('watch?v=')
                              ? profileUser.videoPitchUrl.replace(
                                  'watch?v=',
                                  'embed/'
                                )
                              : profileUser.videoPitchUrl
                  ...
                  <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 border border-ink-200 space-y-4">
                    ...
                    <p className="text-[10px] text-ink-400">
                      {t('studentProfile.skillGapDescription')}
                    </p>
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="flex justify-between text-xs font-bold text-ink-700 mb-1">
                          ...
                          <span className="text-marigold-500">
                            {t('studentProfile.matchPercentage')}
                          </span>
                        </div>
                        <div className="w-full bg-ink-100 h-2 rounded-full overflow-hidden">
                          <div
                            className="bg-marigold-500 h-2 rounded-full"
                            style={{ width: '75%' }}
                          />
                        </div>
                      </div>
                      ...
                      <div className="text-xs space-y-2 pt-2 text-ink-600">
                        <p className="font-semibold text-emerald-600">
                          ✓ {t('studentProfile.inDemandSkillsMet')}{' '}
                          {profileUser.targetSkills || t('studentProfile.none')}
                        </p>
                        <p className="font-semibold text-amber-600">
                          ⚠️ {t('studentProfile.trendingSkillsMissing')}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 border border-ink-200 space-y-4">
                    <div className="flex justify-between items-center border-b pb-2.5">
                      <h3 className="text-sm font-black text-ink-800 uppercase tracking-wider">
                        🤝{' '}
                        {t('studentProfile.peerEndorsements', {
                          count: profileUser.softSkillsVouches?.length || 0,
                        })}
                      </h3>
                      {!isOwner && currentUser?.userRole === 'student' && (
                        <button
                          ...
                          style={{ background: '#F5A623', color: '#1B2333' }}
                          className="px-2.5 py-1 rounded-lg text-[9px] font-bold transition shadow-sm hover:opacity-90"
                        >
                    ...
                    {!profileUser.softSkillsVouches ||
                    profileUser.softSkillsVouches.length === 0 ? (
                      <div className="wm-panel p-[24px_16px] text-center max-w-sm mx-auto my-4 flex flex-col items-center justify-center">
                        ...
                        <div>
                          <h4 className="text-[14px] font-semibold text-[#1B2333] mb-[4px]">
                            {t('studentProfile.noEndorsementsYet')}
                          </h4>
                          <p className="text-[12px] text-[#6B7280] leading-normal max-w-[200px] mx-auto">
                            No peer endorsements posted. Peer vouching helps
                      ...
                      <div className="space-y-3.5 max-h-60 overflow-y-auto pr-1">
                        {profileUser.softSkillsVouches.map((vouch, idx) => (
                          <div
                            key={idx}
                            className="bg-ink-50 border p-3 rounded-xl space-y-1.5 text-left"
                          >
                            <div className="flex justify-between items-center text-[9px]">
                              <span className="font-bold text-ink-400">
                                {t('studentProfile.vouchedByBatchmate')}
                              </span>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {vouch.skills.map((vs, sIdx) => (
                                <span
                                  key={sIdx}
                                  className="bg-marigold-50 text-marigold-700 text-[8px] font-black px-1.5 py-0.5 rounded border uppercase"
                                >
                                  {vs}
                                </span>
                              ))}
                  ...
                  <div
                    ...
                    className="border border-ink-700 rounded-xl shadow-sm p-6 md:p-8 space-y-6"
                  >
                    <div className="flex justify-between items-center border-b border-ink-600 pb-4">
                      <div>
                        <h3 className="text-base font-bold text-white flex items-center gap-1.5">
                          <span>
                            🧠 {t('studentProfile.aiCvCritiqueReport')}
                          </span>
                          <span
                            style={{
                        ...
                        >
                          {t('studentProfile.verifiedScore')}
                        </p>
                      </div>
                      ...
                      {profileUser.cvReviewReport && (
                        <div className="flex items-center space-x-3 text-right">
                          <div>
                            <p
                              style={{ color: '#F5A623' }}
                              className="text-[9px] uppercase font-bold opacity-70"
                            >
                              {t('studentProfile.qualityScore')}
                            </p>
                            <p
                              style={{ color: '#F5A623' }}
                              className="text-2xl font-black"
                            >
                              {profileUser.cvReviewReport.score}/100
                            </p>
                          </div>
                          <div
                            style={{ border: '2px solid #F5A623' }}
                            className="relative w-12 h-12 flex items-center justify-center rounded-full bg-white"
                          >
                            <span className="text-[11px] font-black text-ink-800">
                              {profileUser.cvReviewReport.score}%
                            </span>
                          </div>
                        </div>
                      )}
                    ...
                    {profileUser.cvReviewReport ? (
                        ...
                        const cvReport = {
                          ...
                          improvements: Array.isArray(raw.improvements)
                            ...
                            : Array.isArray(raw.Improvements)
                              ? raw.Improvements
                              : Array.isArray(raw.areas_of_improvement)
                                ? raw.areas_of_improvement
                                : typeof raw.improvements === 'string'
                                  ? raw.improvements
                                      .split(',')
                                      .map((s) => s.trim())
                                      .filter(Boolean)
                          ...
                          <div className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <div>
                                ...
                                <ul className="space-y-1.5 text-xs list-disc list-inside">
                                  {cvReport.strengths.length > 0 ? (
                                    ...
                                    <li
                                      style={{ color: '#C8C9C2' }}
                                      className="list-none italic text-[11px]"
                                    >
                              ...
                              <div>
                                <h5 className="text-[11px] font-extrabold uppercase text-amber-400 mb-2 flex items-center gap-1.5">
                                  <span>
                                    ⚠️ {t('studentProfile.areasOfImprovement')}
                                  </span>
                                </h5>
                                <ul className="space-y-1.5 text-xs list-disc list-inside">
                            ...
                            {cvReport.recommendations && (
                              ...
                              >
                                <h5
                                  style={{ color: '#F5A623' }}
                                  className="text-[10px] font-extrabold uppercase mb-1 opacity-80"
                                >
                                  {t('studentProfile.aiRecommendations')}
                                </h5>
                                <p
                                  style={{ color: '#E1E2DC' }}
                      ...
                      <div className="text-center py-8 flex flex-col items-center">
                        ...
                        >
                          {t('studentProfile.noCritiqueGenerated')}
                        </h4>
                  ...
                  <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 border border-ink-200 space-y-4">
                    <h3 className="text-sm font-black text-ink-800 uppercase tracking-wider border-b pb-2.5">
                      💬{' '}
                      {t('studentProfile.clientReviews', {
                        count: ratingsList.length,
                      })}
                    </h3>
                    ...
                    {ratingsList.length === 0 ? (
                      <div className="wm-panel p-[24px_16px] text-center max-w-sm mx-auto my-4 flex flex-col items-center justify-center">
                        ...
                        <div>
                          <h4 className="text-[14px] font-semibold text-[#1B2333] mb-[4px]">
                            {t('studentProfile.noReviewsYet')}
                          </h4>
                          <p className="text-[12px] text-[#6B7280] leading-normal max-w-[200px] mx-auto">
                            No reviews or ratings posted yet. Completed projects
                            will trigger client reviews here.
                          </p>
                        </div>
                      </div>
                    ) : (
                          ...
                          >
                                  ...
                                  <span
                                    ...
                                    className={
                                      star <= app.rating
                                        ...
                                        : 'text-ink-200 text-xs'
                                    }
                                  >
                                    ★
                                  </span>
                                ))}
                                <span className="font-extrabold text-ink-700 ml-1">
                                  ({app.rating}/5)
                                </span>
                              </div>
                            </div>
                            ...
                            {app.feedbackText && (
                              <p className="text-[10px] text-ink-400 italic leading-relaxed">
                                <strong>{t('studentProfile.feedback')}</strong>"
                                {app.feedbackText}"
                              </p>
                            )}
                          </div>
        ...
        <div className="fixed inset-0 bg-ink-900/60 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl max-w-md w-full shadow-sm p-6 border text-left flex flex-col animate-fade-in select-none">
            <div className="flex justify-between items-center border-b pb-3 mb-4">
              <h3 className="font-black text-ink-800 text-sm uppercase tracking-wider">
                {t('studentProfile.endorseBatchmate')}
              </h3>
              <button
            ...
            <form onSubmit={handleVouchSubmit} className="space-y-4">
              <div>
                <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1">
                  {t('studentProfile.vouchedSkills')}
                </label>
                <input
                  type="text"
                  ...
                  className="w-full bg-ink-50 border text-xs px-3.5 py-2.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-marigold-400"
                  required
                />
              </div>
              ...
              <div>
                <label className="block text-[10px] font-bold text-ink-400 uppercase mb-1">
                  {t('studentProfile.recommendationStatement')}
                </label>
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-ink-50 border text-xs px-3.5 py-2.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-marigold-400 resize-none"
                  required
                />
              </div>
              ...
              <div className="flex justify-end gap-2.5 pt-2">
                ...
                <button
                  ...
                  disabled={vouching}
                  style={{ background: '#F5A623', color: '#1B2333' }}
                  className="px-4 py-2 rounded-xl text-xs font-black transition shadow hover:opacity-90"
                >
                  {vouching
                    ? t('studentProfile.submitting')
                    : t('studentProfile.submitVouch')}
                </button>
              </div>
            </form>
          </div>
