...
export function ThemeProvider({ children}) {const [theme, setTheme] = useState(() => {// Check local storage. If nothing is saved, default to light mode to ensure the beautiful gradient shows.
 if (typeof window !=="undefined") {const savedTheme = localStorage.getItem("theme");
