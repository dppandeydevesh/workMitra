...
export default function CompanyDashboard() {
  ...
  const getStatusColor = (status) => {
    const map = {
      ...
      "Submitted": "text-purple-600 bg-purple-50 border-purple-100 dark:border-ink-800",
    ...
    return map[status] || "text-ink-600 dark:text-ink-300 bg-ink-50 dark:bg-ink-900 border-ink-100 dark:border-ink-800";
  };
