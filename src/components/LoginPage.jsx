...
export default function LoginPage() {const navigate = useNavigate();
 ...
 <p className="text-purple-900/80 mt-2 text-sm md:text-base font-semibold leading-relaxed">{t("login.choosePathDesc")}</p>
 </div>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full z-10 px-4">
 
 <button onClick={() => { setUserRole("student"); setView("auth");}} className="group text-left p-8 bg-white/40 border border-ink-200 rounded-[32px] hover:border-purple-400 hover:bg-white/60 transition-all duration-300 relative overflow-hidden">
 <div className="absolute -right-4 -bottom-4 text-8xl opacity-10">💼</div>
 <div className="w-12 h-12 rounded-xl bg-purple-50 text-white flex items-center justify-center text-2xl mb-4">🚀</div>
 <h3 className="text-2xl font-bold text-purple-950 mb-2">{t("login.needJobTitle")}</h3>
 <p className="text-sm text-purple-900/70">{t("login.needJobDesc")}</p>
 </button>

 <button onClick={() => { setUserRole("company"); setView("auth");}} className="group text-left p-8 bg-white/40 border border-ink-200 rounded-[32px] hover:border-pink-400 hover:bg-white/60 transition-all duration-300 relative overflow-hidden">
 <div className="absolute -right-4 -bottom-4 text-8xl opacity-10">🏢</div>
 <div className="w-12 h-12 rounded-xl bg-pink-500 text-white flex items-center justify-center text-2xl mb-4">🤝</div>
 <h3 className="text-2xl font-bold text-purple-950 mb-2">{t("login.wantToHireTitle")}</h3>
 <p className="text-sm text-purple-900/70">{t("login.wantToHireDesc")}</p>
 </button>

 <button onClick={() => { setUserRole("college"); setView("auth");}} className="group text-left p-8 bg-white/40 border border-ink-200 rounded-[32px] hover:border-marigold-400 hover:bg-white/60 transition-all duration-300 relative overflow-hidden">
 <div className="absolute -right-4 -bottom-4 text-8xl opacity-10">🎓</div>
 <div className="w-12 h-12 rounded-xl bg-marigold-500 text-white flex items-center justify-center text-2xl mb-4">🏫</div>
 <h3 className="text-2xl font-bold text-purple-950 mb-2">{t("login.professorTitle")}</h3>
 <p className="text-sm text-purple-900/70">{t("login.professorDesc")}</p>
 </button>
 ...
 <button onClick={() => { setView("landing"); setErrorMessage("");}} className="absolute top-6 left-6 px-4 py-2 bg-purple-950/10 border border-purple-950/20 rounded-full text-xs font-bold text-purple-950 transition">← {t("login.backToPaths")}</button>
 ...
 <div>
 <h2 className="text-2xl font-black text-purple-950">{t("login.verifyAccount")}</h2>
 ...
 <div className="pt-2">
 <button
 type="button"onClick={() => { setIsOtpVerifying(false); setErrorMessage("");}}
 ...
 <button type="button" onClick={() => { setIsSignUp(false); setErrorMessage("");}} className="border-2 border-white text-white text-xs font-bold uppercase tracking-wider px-10 py-2.5 rounded-xl bg-transparent hover:bg-white hover:text-purple-950 transition-all active:scale-95">{t("login.signInBtn")}</button>
 </div>
 ...
 <button type="button" onClick={() => { setIsSignUp(true); setErrorMessage("");}} className="border-2 border-white text-white text-xs font-bold uppercase tracking-wider px-10 py-2.5 rounded-xl bg-transparent hover:bg-white hover:text-purple-950 transition-all active:scale-95">{t("login.signUpBtn")}</button>
 </div>
 </div>
 </div>
 ...
 <div>
 <h2 className="text-2xl font-black text-purple-950">{t("login.resetPassword")}</h2>
 ...
 <input
 type="email"placeholder={t("login.enterRegisteredEmail")}
 value={recoveryEmail}
 onChange={(e) => setRecoveryEmail(e.target.value)}
 className="w-full bg-purple-50/60 border border-purple-100 text-sm px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400"required
 />
 
 <button
 type="submit"disabled={sendingRecovery}
 ...
 <div className="pt-2">
 <button
 type="button"onClick={() => { setView("auth"); setErrorMessage("");}}
 className="text-xs text-purple-600 hover:text-pink-600 font-bold transition hover:underline">
