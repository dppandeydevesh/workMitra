...
export default function StudentProfile() {
  ...
  return (
    <div className="min-h-screen dark:bg-slate-950 dark:bg-none bg-transparent font-sans">
                ...
                <div>
                  <div className="flex items-center flex-wrap gap-2">
                    ...
                    {profileUser.linkedinUrl && (
                      <a href={profileUser.linkedinUrl} target="_blank" rel="noreferrer" className="text-blue-600 hover:text-blue-800 transition" title="LinkedIn">
