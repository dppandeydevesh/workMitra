  ...
  return (
    <div className="min-h-screen bg-transparent font-sans py-8">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="bg-white dark:bg-ink-900 rounded-3xl shadow-xl p-6 sm:p-8 border border-ink-100 dark:border-ink-800/50">
          <div className="border-b pb-4 mb-6">
            <h1 className="text-xl sm:text-2xl font-black text-ink-800 dark:text-ink-200">⚙️ {t("companySettings.title")}</h1>
          ...
          {companyLogoUrl && (
            <div className="mb-6 flex items-center gap-4">
              <img
                ...
                className="w-16 h-16 rounded-2xl object-cover border-2 border-ink-100 dark:border-ink-800 shadow-sm bg-ink-50 dark:bg-ink-900"
                onError={(e) => { e.target.style.display = "none"; }}
              />
              <div>
                <p className="text-sm font-bold text-ink-800 dark:text-ink-200">{companyName || t("companySettings.defaultCompanyName")}</p>
          ...
          <form onSubmit={handleSave} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-ink-50 dark:bg-ink-800 border p-3 rounded-xl text-xs outline-none focus:ring-2 focus:ring-marigold-400 focus:bg-white dark:bg-ink-900 transition"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-ink-50 dark:bg-ink-800 border p-3 rounded-xl text-xs outline-none focus:ring-2 focus:ring-marigold-400 focus:bg-white dark:bg-ink-900 transition resize-none"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-ink-50 dark:bg-ink-900 border p-3 rounded-xl text-xs outline-none focus:ring-2 focus:ring-marigold-400"
                  >
            ...
            <div className="flex items-center gap-3 p-4 bg-ink-50 dark:bg-ink-800 border rounded-2xl">
              ...
              />
              <label htmlFor="autoApprove" className="text-xs font-bold text-ink-700 dark:text-ink-300 cursor-pointer select-none">
